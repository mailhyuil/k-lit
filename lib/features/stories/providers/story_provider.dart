...
final storiesByCollectionIdProvider =
    FutureProvider.family<List<Story>, String>((ref, collectionId) async {
      final client = ref.watch(supabaseClientProvider);
      final response = await client
          .from('stories')
          .select('''
...
final storyByStoryIdProvider = FutureProvider.family<Story?, String>((
  ref,
  storyId,
) async {
  try {
